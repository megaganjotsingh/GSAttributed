...
protocol GSAttriburedCompatible {
    associatedtype CompatibleType
    var attributed: CompatibleType { get }
}
 
extension GSAttriburedCompatible {
    var attributed: GSAttributed<Self> {
        GSAttributed(self)
    }
}

extension String: GSAttriburedCompatible {}
extension NSAttributedString: GSAttriburedCompatible {}
